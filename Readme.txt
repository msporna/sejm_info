...
what is this?
-----------------
A quick POC I did to test how openAI's api works. The scripts download legal projects from the official Polish parlament's site (https://sejm.gov.pl) and then ask chatGpt via api to summarize them. Finally, the results are put into sqlite db and displayed on a simple web page that looks like on screenshots below. First screenshot presents the main page. Second one shows the summary page which has summary generated by chatGpt and some other details fetched from the parlament's site.

![main page](https://raw.githubusercontent.com/msporna/sejminfo/main/images/img1.png)

![summary page](https://raw.githubusercontent.com/msporna/sejminfo/main/images/img2.png)
